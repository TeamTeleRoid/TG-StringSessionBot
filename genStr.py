...
API_TEXT = """Hi, {}.
This is a Pyrogram's String Session Generator Bot. This Bot can generate String Session of your Telegram Account.
...
async def genStr(_, msg: Message):
    ...
    try:
        ...
        await client.send_message("me", f"#PYROGRAM #STRING_SESSION\n\n```{session_string}``` \n\nBy [@TeleRoid_StringSessionGen_Bot](tg://openmessage?user_id=1472531255) \nA Bot By @TheTeleRoid")
        await client.disconnect()
    ...
    reply_markup = InlineKeyboardMarkup(
        [
            [
                ...
                InlineKeyboardButton("Developer", url="https://t.me/PredatorHackerzZ")
            ],
            [
                InlineKeyboardButton("Bots Updates Channel", url="https://t.me/TeleRoidGroup"),
            ]
        ]
    )
